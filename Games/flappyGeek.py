...
game_images = {}
framepersecond = 32
pipeimage = 'Images/Flappy/pipe.png'
background_image = 'Images/Flappy/background.jpg'
birdplayer_image = 'Images/Flappy/bird.png'
sealevel_image = 'Images/Flappy/base.jfif'
...
def play():
	...
	game_images['scoreimages'] = (
		pygame.image.load('Images/Flappy/0.png').convert_alpha(),
		pygame.image.load('Images/Flappy/1.png').convert_alpha(),
		pygame.image.load('Images/Flappy/2.png').convert_alpha(),
		pygame.image.load('Images/Flappy/3.png').convert_alpha(),
		pygame.image.load('Images/Flappy/4.png').convert_alpha(),
		pygame.image.load('Images/Flappy/5.png').convert_alpha(),
		pygame.image.load('Images/Flappy/6.png').convert_alpha(),
		pygame.image.load('Images/Flappy/7.png').convert_alpha(),
		pygame.image.load('Images/Flappy/8.png').convert_alpha(),
		pygame.image.load('Images/Flappy/9.png').convert_alpha()
	)
