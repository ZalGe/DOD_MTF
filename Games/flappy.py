...
game_images = {}
FPS = 30
pipeimage = 'Games/Images/Flappy/pipe.png'
background_image = 'Games/Images/Flappy/background2.jpg'
birdplayer_image = 'Games/Images/Flappy/bird.png'
sealevel_image = 'Games/Images/Flappy/base3.jpg'
...
def play_flappy():
    ...
    game_images['scoreimages'] = (
        pygame.image.load('Games/Images/Flappy/0.png').convert_alpha(),
        pygame.image.load('Games/Images/Flappy/1.png').convert_alpha(),
        pygame.image.load('Games/Images/Flappy/2.png').convert_alpha(),
        pygame.image.load('Games/Images/Flappy/3.png').convert_alpha(),
        pygame.image.load('Games/Images/Flappy/4.png').convert_alpha(),
        pygame.image.load('Games/Images/Flappy/5.png').convert_alpha(),
        pygame.image.load('Games/Images/Flappy/6.png').convert_alpha(),
        pygame.image.load('Games/Images/Flappy/7.png').convert_alpha(),
        pygame.image.load('Games/Images/Flappy/8.png').convert_alpha(),
        pygame.image.load('Games/Images/Flappy/9.png').convert_alpha()
    )
